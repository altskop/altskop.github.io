...
const people = [
    ...
    {'name': 'Dreamydiglett', 'twitch': 'Dreamydiglett', 'emotes': [{'src': 'assets/dreamydiglett/arrive256px.gif'}, {'src': 'assets/dreamydiglett/chomp256px.gif'}, {'src': 'assets/dreamydiglett/dreamyFine_256px.gif'}, {'src': 'assets/dreamydiglett/dreamyFlustered_128px.gif'}, {'src': 'assets/dreamydiglett/dreamyGiggle_256px.gif'}, {'src': 'assets/dreamydiglett/dreamyNodders_112px.gif'}, {'src': 'assets/dreamydiglett/dreamyNotes_112px.gif'}, {'src': 'assets/dreamydiglett/dreamyShake_112px.gif'}, {'src': 'assets/dreamydiglett/dreamyTap_112px.gif'}, {'src': 'assets/dreamydiglett/dreamyWave_112px.gif'}, {'src': 'assets/dreamydiglett/dumpy256px.gif'}, {'src': 'assets/dreamydiglett/Emma_licku256.gif'}, {'src': 'assets/dreamydiglett/homi256px.gif'}, {'src': 'assets/dreamydiglett/hype256.gif'}, {'src': 'assets/dreamydiglett/modcheck256.gif'}, {'src': 'assets/dreamydiglett/wiggle256.gif'}]},
